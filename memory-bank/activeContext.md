...
家計簿のサマリー表示とグラフ絞り込み、スケジュールの週開始曜日選択を改善し、
Django・TypeScript・Playwrightの関連テストで検証した。
...
- コミット`33fc3fe`まで本番へ反映済み。初回転送は172オブジェクト・33,835,782バイトをS3で確認し、journalは4.0GBから72MB、ディスクは使用率24%・空き31GBになった。4コンテナ稼働とHTTP 200を確認した。
...
1. 本番実機で家計簿の各グラフ要素と週開始曜日の操作性を継続確認する。
